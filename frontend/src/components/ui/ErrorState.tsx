...
export const ErrorState: React.FC<ErrorStateProps> = ({
  title = 'Data Feed Connection Notice',
  message = 'Unable to synchronize telemetry with the remote meteorological node. Showing local resilience models.',
  onRetry,
  className = ''
}) => {
  return (
    ...
    >
      ...
      <p className="text-xs text-ink-700 max-w-sm mt-1 leading-relaxed">{message}</p>
      {onRetry && (
        <button
          onClick={onRetry}
